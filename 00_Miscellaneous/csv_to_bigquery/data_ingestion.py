...
class DataIngestion:
    ...
    def parse_method(self, string_input):
        ...
        row = dict(zip(('id', 'class', 'domain', 'sentence'),
                       values))
...
def run(argv=None):
    ...
    parser.add_argument(
        ...
        default='gs://sentence_similarity/sample_travel_reminders_intent.csv')
    ...
    parser.add_argument('--output', dest='output', required=False,
                        ...
                        default='test_dataflow.sentence_similarity_1')
    ...
    (p
     ...
     | 'Write to BigQuery' >> beam.io.Write(
        beam.io.BigQuerySink(
            ...
            # fieldName:fieldType
            schema='id:STRING,class:STRING,domain:STRING,sentence:STRING',
